...
if __name__ == "__main__":
    ...
    # 統計情報の収集用ツール
    stats = tools.Statistics(lambda ind: (ind.fitness.values[0], getattr(ind, "y_value", None)))
    ...
    with open('/home/sato-lab.org/takayu/project/sato-lab/slurm/logs/deap/img/logbook' + jobid + '_TEonly.pkl', 'wb') as f:
    ...
    plt.savefig('/home/sato-lab.org/takayu/project/sato-lab/slurm/logs/deap/img/plot' + jobid + '_TEonly.png')
